      ...
      <Row className='auth-inner m-0'>
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            {/* <CardText className='mb-1' style={{fontSize: "1.5em"}}>Please connect with your "Wallet Address"</CardText>  */}
            {/* <Form className='auth-login-form mt-2' onSubmit={e => e.preventDefault()}>
              <FormGroup>
                <Label className='form-label mb-1' for='wallet-adrs' style={{fontSize:"1.3em", textAlign: "center", display: "block"}}>
                Please connect with your "Wallet Address"
                </Label>
                <Input type='text' id='wallet-adrs' placeholder='ENTER YOUR WALLET ADDRESS' style={{textAlign:"center", fontSize:"1.3em"}} autoFocus />
              </FormGroup>
              <FormGroup>
