...
import { RefreshCw, Tool, XCircle } from 'react-feather'
                ...
                <ModalBody>
                    <Row className='d-flex flex-column justify-content-center align-items-center'>
                        ...
                        <Col className='text-center'>
                            <Button.Ripple color='primary' onClick={handleGetSegaInfo}><RefreshCw className='mr-1' size={20} />Refresh Info</Button.Ripple>
                        </Col>
                        {haveInfo ? (
                            <>
                                <Col className='py-1'>
